...
// Vendored from @gluwa/asc-contracts@0.2.1 (contracts/common/EvmV1Decoder.sol).
// Pragma adjusted to ^0.8.26 (verified: no 0.8.28-only features; compiles clean).
// Logic byte-identical to upstream; MIT attribution retained.
