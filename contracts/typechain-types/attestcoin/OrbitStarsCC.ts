...
export interface OrbitStarsCCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface OrbitStarsCC extends BaseContract {
  connect(runner?: ContractRunner | null): OrbitStarsCC;
  waitForDeployment(): Promise<this>;

  interface: OrbitStarsCCInterface;
