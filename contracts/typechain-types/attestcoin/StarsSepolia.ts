...
export interface StarsSepoliaInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface StarsSepolia extends BaseContract {
  connect(runner?: ContractRunner | null): StarsSepolia;
  waitForDeployment(): Promise<this>;

  interface: StarsSepoliaInterface;
