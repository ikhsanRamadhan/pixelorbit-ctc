...
const aliens = [
    { name: 'Alien1', image: alien1, color: "#fab955", hp: 5, maxFrame: 8 },
    { name: 'Alien2', image: alien2, color: "#fab955", hp: 6, maxFrame: 8 },
    { name: 'Alien3', image: alien3, color: "#391f57", hp: 7, maxFrame: 15 },
    { name: 'Alien4', image: alien4, color: "#391f57", hp: 8, maxFrame: 15 },
    { name: 'Alien5', image: alien5, color: "#ee2768", hp: 9, maxFrame: 9 },
    { name: 'Alien6', image: alien6, color: "#f9c228", hp: 10, maxFrame: 7 },
];
